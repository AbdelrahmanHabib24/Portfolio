...
const skillsData = [
  {
    ...
    levelText: "Advanced",
    levelBadgeStyle: "bg-cyan-500/10 text-cyan-400 border-cyan-500/30",
  ...
  },
  {
    ...
    boxBorder: "border-slate-600 shadow-[0_0_20px_rgba(255,255,255,0.15)]",
  },
  {
    name: "Redux",
    description: "Managing global state with predictable patterns.",
    levelText: "Advanced",
    levelBadgeStyle: "bg-purple-500/10 text-purple-400 border-purple-500/30",
    dots: [true, true, true, true, true, false],
  ...
  },
  {
    ...
    levelText: "Proficient",
    levelBadgeStyle: "bg-blue-500/10 text-blue-400 border-blue-500/30",
    dots: [true, true, true, true, false, false],
  ...
  },
  {
    ...
    levelText: "Advanced",
    levelBadgeStyle: "bg-amber-500/10 text-amber-400 border-amber-500/30",
    dots: [true, true, true, true, true, false],
  ...
  },
  {
    ...
    levelText: "Advanced",
    levelBadgeStyle: "bg-orange-500/10 text-orange-400 border-orange-500/30",
    dots: [true, true, true, true, true, false],
  ...
  },
  {
    ...
    levelBadgeStyle: "bg-sky-500/10 text-sky-400 border-sky-500/30",
  ...
  },
  {
    ...
    levelText: "Advanced",
    levelBadgeStyle: "bg-slate-500/10 text-slate-300 border-slate-500/30",
    dots: [true, true, true, true, true, false],
    dotColor: "bg-slate-300 shadow-[0_0_8px_#cbd5e1]",
